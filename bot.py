...
🔄 <i>Это подписка. Для автопродления поставьте галочку «Сохранить карту» при оплате. Отменить можно в любой момент в профиле.</i>
...
☑️ <b>Важно:</b> для автопродления поставьте галочку «Сохранить карту» на странице оплаты.

Отменить подписку можно в любой момент в «👤 Мой профиль».""",
